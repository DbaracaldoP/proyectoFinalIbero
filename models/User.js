...
módulo . exportaciones  =  mangosta . modelo ( 'usuario' , UserSchema ) ;    // aqui es donde se nombra la colleccion d ela base de datos PanisofMean y le agregan una s al final
